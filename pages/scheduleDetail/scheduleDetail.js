...
Page({
    ...
    onLoad: function(options) {
        ...
        this.setData({
            infoList: JSON.stringify(today_list).indexOf('"showItem":true') > 0 ? today_list : [],
            todayList: JSON.stringify(today_list).indexOf('"showItem":true') > 0 ? today_list : []
        });
    },
